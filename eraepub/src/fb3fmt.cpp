...
void GetFb3Metadata(CrDom *dom, lString16 *res_title, lString16 *res_authors, lString16 *res_lang,
        lString16 *res_series, int * res_series_number)
{
    lString16 title;
    lString16 authors;
    lString16 lang;
    ...
    title = dom->textFromXPath(lString16("fb3-description/title/main")).trim();
    title += " " + dom->textFromXPath(lString16("fb3-description/title/sub")).trim();

    lang = dom->textFromXPath(lString16("fb3-description/lang")).trim();
