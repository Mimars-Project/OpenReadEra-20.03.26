...
//                }
			...
			if( CSS_EMBEDDED_STYLES_LEVEL > 0)
            {
...
void GetEpubMetadata(CrDom *dom, lString16 *res_title, lString16 *res_authors, lString16 *res_lang,lString16 *res_series, int * res_series_number)
{
    lString16 title;
    lString16 authors;
    lString16 lang;
